...
from src.application.user.services.sanitization.fields.email import (
    EmailSanitization,
)
from src.utils.sanitizers.field import FieldSanitizer
from src.utils.sanitizers.sanitization.custom.email import (
...
class TestEmailSanitization:
    ...
    def test_base_sanitization(
        ...
        mock_validate_email = mocker.patch(
            "src.application.user.services.sanitization.fields.email.validate_email",
