...
from src.application.user.services.sanitization.inputs import (
...
async def test_sanitize_user_create(
    ...
    mock_sanitize_all_fields_pasword_match = mocker.patch(
        "src.application.user.services.sanitization.inputs.sanitize_all_fields_password_match",
...
async def test_sanitize_verify_email_request(
    ...
    mock_sanitize_all_fields_pasword_match = mocker.patch(
        "src.application.user.services.sanitization.inputs.sanitize_only_email",
        return_value=expected_output,
    )
...
async def test_sanitize_password_reset_confirm(
    ...
    mock_sanitize_passwords = mocker.patch(
        "src.application.user.services.sanitization.inputs.sanitize_passwords",
        return_value=expected_output,
    )
