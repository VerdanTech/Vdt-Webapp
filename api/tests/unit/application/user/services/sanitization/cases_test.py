...
from src.verdantech_api.application.user.services.sanitization.cases import (
    sanitize_all_fields_password_match,
    sanitize_only_email,
    sanitize_passwords,
)
from src.verdantech_api.domain.models.user.services.sanitization import UserSanitizer
from src.verdantech_api.domain.utils.sanitizers.field import DISABLE_FIELD
...
async def test_sanitize_all_fields_password_match(
    ...
    mock_validate_password_match = mocker.patch(
        "src.verdantech_api.application.user.services.sanitization.cases.validate_password_match"
    )
