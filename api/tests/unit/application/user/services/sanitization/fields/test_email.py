...
from src.verdantech_api.application.user.services.sanitization.fields.email import (
    EmailSanitization,
)
...
class TestEmailSanitization:
    ...
    def test_base_sanitization(
        ...
        mock_validate_email = mocker.patch(
            "src.verdantech_api.application.user.services.sanitization.fields.email.validate_email",
