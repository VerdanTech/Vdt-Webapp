...
const iconIds = {
	...
	gardenIcon: 'material-symbols:home-and-garden-outline-rounded',
	gardenDashboardIcon: 'material-symbols:space-dashboard-outline',
	gardenMembersIcon: 'ph:users-three',
	gardenMetricsIcon: 'material-symbols:bar-chart-4-bars-rounded',
	gardenPlannerIcon: 'mdi:planner-outline',
	gardenPlannerWorkbookIcon: 'material-symbols:checklist-rounded',
	...
	verdagraphPlansIcon: 'mdi:application-edit-outline',
