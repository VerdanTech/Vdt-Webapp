export const cultivarFields = {
    ...
    cultivar_names: {
        ...
        description: 'A set of common names associated with this plant species. Each name must be between 3 and 30 characters long and contain only alphanumeric characters and spaces. There must be at least 1 name and a maximum of 10 names',
    },
    cultivar_key: {
        min_length: {
            value: 1,
    ...
    cultivar_collection_visibility: {
        description: 'Public collections may be viewed by anyone and are publicly searchable. Unlisted collections may be viewed by anyone with the link. Private collections may only be owned by the creator, or by those in the garden if it is located within one.',
    },
