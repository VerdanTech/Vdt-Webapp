<script lang="ts">
    ...
    let {attributeKey, attributeValue, form, editing} = $props()
</script>
...
<Field {form} name="scientific_name">
    <Control let:attrs>
        <div class="flex items-center justify-between">
            ...
            <svelte:component this={attributeKeyToComponent(attributeKey)} {...{editing: true}}/>
        </div>
    </Control></Field
>
{:else}
<div class="flex items-center justify-between">
    ...
    <svelte:component this={attributeKeyToComponent(attributeKey)} {...{editing: false}}/>
</div>
{/if}