...
from src.user.domain import PasswordResetConfirmation, User, exceptions
...
class TestUser:
    ...
    def test_email_confirmation_create(self, user: User, mocker: MockerFixture) -> None:
        ...
        """
        mocker.patch(
            "src.user.domain.email.Email.new_confirmation",
            return_value=Email(
    ...
    def test_is_expired(
        ...
        Args:
            ...
            mocker (MockerFixture): pytest-mock.
        """
        mock_datetime = mocker.patch("src.user.domain.user.datetime")
    ...
    def test__set_primary_email(self, user: User, mocker: MockerFixture) -> None:
        ...
        mocker.patch(
            "src.user.domain.email.Email.make_primary",
