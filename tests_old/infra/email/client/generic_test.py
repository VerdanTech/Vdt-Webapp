...
class TestBaseEmailClient:
    ...
    def test_template_html(
        ...
        Args:
            ...
            kwargs (Dict[str, Any]): The arguments to be inserted into input.
    ...
    # ======================================
    # BaseEmailClient.html_to_plain_text() tests
    # ======================================
    ...
    def test_html_to_plain(
        ...
        mocked_processor = mocker.patch(
            "src.common.adapters.email.client.generic.html2text.HTML2Text.handle",
    ...
    # ======================================
    # BaseEmailClient.compile_message() tests
    # ======================================
    ...
    # ======================================
    # BaseEmailClient.compile_and_send() tests
    # ======================================
    ...
    async def test_compile_and_send(
        ...
        Args:
            ...
            mocker (MockerFixture): pytest-mock
        """
        file_mock = mocker.patch("src.common.adapters.email.client.generic.read_file_async")
